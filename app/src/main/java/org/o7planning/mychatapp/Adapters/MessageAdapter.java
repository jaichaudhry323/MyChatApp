...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MessageViewHolder> {
    ...
    public MessageAdapter(Context context, List<Chat> chat, String ImgUrl, String leftuserid, String rightuserid) {
        mChat = chat;
        mImageUrl = ImgUrl;
        mContext = context;
...
//            profile_image=itemView.findViewById(R.id.profile_image);
    ...
    public int getItemViewType(int position) {
        ...
        if (viewchats == 1) {
            if (mChat.get(position).getSender().equals(rightuserid)) {
